function Footer() {
  return (
    <div className="flex flex-col mt-20  bottom-0">
      <div className="lg:flex lg:flex-row lg:space-y-0 sm:space-y-8 sm:flex sm:flex-col lg:px-0 sm:px-4 md:items-center lg:space-x-16 bg-neutral-200   lg:justify-around  py-6">
        ...
        <div className="md:flex md:flex-row sm:flex sm:flex-col sm:justify-start ml-6 md:space-x-6">
