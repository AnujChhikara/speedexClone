...
function Body() {
  return (
    <div>
      ...
      <div
        data-aos="slide-left"
        className="flex justify-center items-center mt-20 ml-10"
      >
        <div className="flex flex-col w-72 space-y-6 mr-24">
          <h2 className="text-7xl text-black">Single Wall</h2>
          <a href="/single-wall">
            <button className="bg-black hover:bg-gray-800  text-white text-md px-2 w-28 py-2 rounded-3xl">
              SHOP NOW
            </button>
          </a>
        </div>
      ...
      >
        <div className="flex flex-col w-72 space-y-6 mr-24">
          ...
          <a href="/hot-n-cold">
            <button className="bg-black text-white hover:bg-gray-800 text-md px-2 w-28 py-2 rounded-3xl">
              SHOP NOW
            </button>
          </a>
        </div>
      ...
      <div className="flex flex-col space-y-20 mt-44 mb-20">
        ...
        <div className="flex justify-center  items-center space-x-10">
          <div className="w-[600px]  h-[800px] shadow-lg shadow-gray-700 bg-firstCard rounded-lg flex flex-col justify-center  space-y-4 items-center">
          ...
          <div className="w-[600px] h-[800px] shadow-lg shadow-gray-700  bg-secondCard rounded-lg flex flex-col justify-center  space-y-4 items-center">
            <h3 className="text-5xl mt-32 font-semibold  text-white">
              Gifting
            </h3>
            <button className="text-sm bg-white px-4 py-3 rounded-3xl hover:-translate-y-0.5 duration-700 shadow-md">
        ...
        {/* second set */}
        <div className="flex justify-center items-center space-x-10">
          <div className="w-[600px] h-[800px] shadow-lg shadow-gray-700  bg-thirdCard rounded-lg flex flex-col justify-center  space-y-4 items-center">
            <h3 className="text-5xl mt-32 font-semibold text-white">
              Accessories
            </h3>
            <button className="text-sm bg-white px-4 py-3 rounded-3xl hover:-translate-y-0.5 duration-700 shadow-md">
          ...
          <div className="w-[600px] h-[800px] shadow-lg shadow-gray-700  bg-fourthCard rounded-lg flex flex-col justify-center  space-y-4 items-center">
